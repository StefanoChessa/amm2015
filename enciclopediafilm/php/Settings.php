...
class Settings {
    ...
    public static $db_user = 'chessaStefanorai';
    public static $db_password = 'cardellino5687';
    public static $db_name='amm15_chessaStefanorai';
        ...
        if (!isset(self::$appPath)) {
            ...
            switch ($_SERVER['HTTP_HOST']) {
                case 'localhost':
                    ...
                    self::$appPath = 'http://' . $_SERVER['HTTP_HOST'] . 'progetto-amm/enciclopediafilm/';
                    break;
                case 'spano.sc.unica.it':
                    // configurazione pubblica
                    self::$appPath = 'http://' . $_SERVER['HTTP_HOST'] . '/amm2015/chessaStefanorai/enciclopediafilm/';
                    break;
