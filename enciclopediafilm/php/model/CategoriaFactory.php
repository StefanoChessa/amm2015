...
include_once 'CasaProduttriceFactory.php';
...
*/
    public function &getCategoriaPerId($id) {
        ...
        if (!$stmt->bind_result($id, $nomecategoria, $idcasaproduttrice)) {
            error_log("[getCategoriaPerId] impossibile" .
        ...
        while ($stmt->fetch()) {
            ...
            $categoria->setCasaProduttrice(CasaProduttriceFactory::instance()->getCasaProduttricePerId($idcasaproduttrice));
        }
...
*/
    private function getCategoria($row) {
        ...
        $categoria->setCasaProduttrice(CasaProduttriceFactory::instance()->getCasaProduttricePerId($row['idcasaproduttrice']));
        return $categoria;
    }
